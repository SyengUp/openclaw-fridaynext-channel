...
export default defineConfig({
  resolve: {
    alias: {
      "openclaw/plugin-sdk/device-bootstrap": path.resolve(
        __dirname,
      ...
      "openclaw/plugin-sdk/question-gateway-runtime": path.resolve(
        __dirname,
        "src/test-support/mock-question-gateway-runtime.ts",
      ),
